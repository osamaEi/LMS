    ...
    public function showLink(string $service)
    {
        $services = [
            ...
            'blackboard' => [
                ...
                'steps'       => ['ادخل إلى البلاك بورد', 'اختر المادة من قائمة مقرارتك', 'تصفح المحتوى أو سلّم الواجب'],
            ],
            'calendar' => [
                'key'         => 'calendar_url',
            ...
            'schedule' => [
                ...
                'steps'       => ['ادخل لنظام الجدول الدراسي', 'تأكد من الفصل التدريبيالحالي', 'نزّل الجدول أو احفظه كصورة'],
            ],
        ];
