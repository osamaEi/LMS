...
class ProgramSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $programs = [
            ...
            [
                'name_ar'     => 'خدمة العملاء والعلاقات العامة',
                'name_en'     => 'Customer Service and Public Relations',
                'code'        => 'DEV-004',
            ...
            [
                'name_ar'     => 'أسرار النجاح والتميز في العمل',
                'name_en'     => 'Secrets of Success and Excellence at Work',
                'code'        => 'DEV-005',
            ...
            [
                'name_ar'     => 'التدريب على مهارات برنامج نور',
                'name_en'     => 'Noor Program Skills Training',
                'code'        => 'DEV-006',
            ...
            [
                'name_ar'     => 'تطوير مهارات المدربين',
                'name_en'     => 'Trainer Skills Development',
                'code'        => 'DEV-007',
            ...
            [
                'name_ar'     => 'فن السكرتارية وإدارة المكاتب',
                'name_en'     => 'Art of Secretarial and Office Management',
                'code'        => 'DEV-008',
            ...
            [
                'name_ar'     => 'أساسيات استخدام ويندوز 7 وأوفيس 2007',
                'name_en'     => 'Windows 7 and Office 2007 Fundamentals',
                'code'        => 'DEV-009',
            ...
            [
                'name_ar'     => 'المهارات الأساسية للحاسب وقواعد السلوك الوظيفي',
                'name_en'     => 'Basic Computer Skills and Professional Conduct',
                'code'        => 'DEV-010',
            ...
            [
                'name_ar'     => 'فوتوشوب المستوى المبتدئ',
                'name_en'     => 'Photoshop — Beginner Level',
                'code'        => 'DEV-011',
            ...
            [
                'name_ar'     => 'أسرار المقابلات الشخصية',
                'name_en'     => 'Personal Interview Secrets',
                'code'        => 'DEV-012',
            ...
            [
                'name_ar'     => 'الأرشفة الإلكترونية',
                'name_en'     => 'Electronic Archiving',
                'code'        => 'DEV-013',
            ...
            [
                'name_ar'     => 'أساسيات الرسم',
                'name_en'     => 'Drawing Fundamentals',
                'code'        => 'DEV-014',
            ...
            [
                'name_ar'     => 'المهارات المتقدمة في برنامج الاكسل',
                'name_en'     => 'Advanced Excel Skills',
                'code'        => 'DEV-016',
            ...
            [
                'name_ar'     => 'إدارة الوقت والتعامل مع الضغوط',
                'name_en'     => 'Time Management and Stress Handling',
                'code'        => 'DEV-017',
            ...
            [
                ...
                'name_en'     => 'Artificial Intelligence Fundamentals',
                'code'        => 'DEV-018',
