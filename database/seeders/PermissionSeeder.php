...
class PermissionSeeder extends Seeder
{
    ...
    public static array $permissions = [
        ...
        // ─── الفصول التدريبي ة ───────────────────────────
        'view-terms'                     => 'عرض الفصول التدريبي ة',
        'create-terms'                   => 'إضافة فصول دراسية',
        'edit-terms'                     => 'تعديل الفصول التدريبي ة',
        'delete-terms'                   => 'حذف الفصول التدريبي ة',

        // ─── المقررات  التدريبي ة ───────────────────────────
        'view-subjects'                  => 'عرض المقررات  التدريبي ة',
        'create-subjects'                => 'إضافة مقرارت دراسية',
        'edit-subjects'                  => 'تعديل المقررات  التدريبي ة',
        'delete-subjects'                => 'حذف المقررات  التدريبي ة',
