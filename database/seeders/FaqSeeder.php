    ...
    public function run(): void
    {
        ...
        $faqs = [
            ...
            [
                ...
                'answer_ar'   => 'نظام الفصل التدريبي هو نظام تقسيم الدبلوم التدريبي  إلى فترات زمنية محددة (ترم)، مدة كل منها فترة معينة، مما يساعد في تنظيم العملية التدريبية  وتقييم تقدم المتدرب بشكل دوري.',
