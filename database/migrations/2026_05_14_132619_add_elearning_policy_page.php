...
<ul>
    ...
    <li>الآلية المتبعة لمنع انتحال الهوية وفحص أعمال المتدربون  ومنع الغش للبرامج التي تزيد مدتها عن شهر.</li>
</ul>
...
<p>وجود سياسة للحضور تضمن احتساب الحضور الإلكتروني معادلاً للحضور الاعتيادي، مع توضيح الحد الأدنى لساعات حضور البرنامج والإجراءات المتخذة في حق المتدرب في حال عدم الالتزام بذلك. كما تلتزم الجهة بمتابعة حضور المتدربون  في التدريب المتزامن وغير المتزامن.</p>
...
<p>توضح الجهة سياسة التواصل بين المستفيدين في بيئة التعليم/التدريب الإلكتروني بما فيها التواصل بين المدرب والمتدرب وبين المتدربون  وبعضهم، وتتضمن أدوات التواصل المتاحة مع توضيح آداب التواصل.</p>
...
<p>توفر الجهة نظاماً أو أداة للتحقق من هوية المستفيد عند كل مرة يتم فيها الدخول على نظام إدارة التعلم/المنصة التدريبية ، مثل: ربط الدخول بالهوية الوطنية، أو التحقق الثنائي.</p>

<h3>سابعاً: تعليمات استخدام بيئة التدريب الإلكتروني</h3>
<p>توفر الجهة أدلة إرشادية إلكترونية مصورة وأدلة تفاعلية ومقاطع مرئية للمدرب والمتدرب لشرح نظام إدارة التعلم/المنصة التدريبية  في كافة مراحل التدريب.</p>
<p>تشمل التعليمات المتاحة للمتدرب:</p>
<ul>
    <li>كيفية تسجيل الدخول واختيار الدورات التدريبية  والبدء بعملية التدريب.</li>
...
<p>توفر الجهة تعليمات واضحة عن الدعم الفني للمستفيدين بمختلف فئاتهم، وتضمن تقديم الدعم الفني عند وجود استفسارات أو شكاوى أو حدوث مشكلات تقنية تعيق استمرار العملية التدريبية .</p>
...
<h3>تاسعاً: المحتوى الرقمي للبرامج التدريبية </h3>
<p>توفر الجهة المحتوى الرقمي بشكل كامل على نظام إدارة التعلم/المنصة التدريبية ، على أن يكون المحتوى متوافقاً مع الأهداف والموضوعات المعتمدة. وتتاح خاصية الوصول للفصل الافتراضي من خلال صفحة المقرر للموضوعات المقدمة بالأسلوب المتزامن.</p>

<h3>عاشراً: آلية الإجابة على استفسارات المتدربون </h3>
...
<ul>
    ...
    <li>المدة الزمنية للإجابة على استفسارات المتدربون .</li>
