...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::table('site_settings')->insert([
            ...
            ['key' => 'copyright_ar',          'value' => 'أكاديمية الارتقاء العالي للتدريب. جميع الحقوق محفوظة.', 'created_at' => $now, 'updated_at' => $now],
        ...
        DB::table('pages')->insertOrIgnore([
            [
                ...
                'content_ar' => '<h2>سياسة الخصوصية</h2><p>يلتزم أكاديمية الارتقاء العالي للتدريب بحماية خصوصية مستخدميه. تصف هذه السياسة كيفية جمع معلوماتك الشخصية واستخدامها وحمايتها.</p><p>نحن نجمع المعلومات التي تقدمها طوعاً عند التسجيل أو التواصل معنا. لن نشارك بياناتك مع أطراف ثالثة دون موافقتك.</p>',
            ...
            [
                ...
                'content_ar' => '<h2>الشروط والأحكام</h2><p>باستخدامك لموقع أكاديمية الارتقاء العالي للتدريب، فإنك توافق على الشروط والأحكام التالية. يُرجى قراءتها بعناية قبل استخدام الخدمات.</p><p>يحتفظ الأكاديمية بحق تعديل هذه الشروط في أي وقت. سيتم إخطارك بأي تغييرات جوهرية.</p>',
