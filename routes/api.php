...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::prefix('student')->group(function () {
            ...
            Route::get('/subjects/{id}/info', [App\Http\Controllers\Api\V1\Student\SubjectController::class, 'info']);
            Route::get('/subjects/{id}/sessions/{classId}', [App\Http\Controllers\Api\V1\Student\SubjectController::class, 'sessions'])
                ->whereNumber('classId');
            Route::get('/subjects/{id}/homework', [App\Http\Controllers\Api\V1\Student\SubjectController::class, 'homework']);
            Route::get('/subjects/{id}/files', [App\Http\Controllers\Api\V1\Student\SubjectController::class, 'files']);
            ...
            Route::get('/my-program/{id}', [App\Http\Controllers\Api\V1\Student\ProgramController::class, 'showOne'])
                ->whereNumber('id');
            // Subjects of a diploma program, flat list. Optional ?term_id=
