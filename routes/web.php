...
Route::middleware(['auth', 'role:admin,super_admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/classes/{class}', [\App\Http\Controllers\Admin\ProgramClassController::class, 'show'])->name('classes.show');
    ...
    Route::post('/classes/{class}/delete-sessions', [\App\Http\Controllers\Admin\ProgramClassController::class, 'deleteSessions'])->name('classes.delete-sessions');
    ...
    Route::get('/attendance-limit/export', [\App\Http\Controllers\Admin\AttendanceLimitController::class, 'export'])->name('attendance-limit.export');
...
Route::middleware(['auth', 'role:teacher'])->prefix('teacher')->name('teacher.')->group(function () {
    ...
    Route::get('/quizzes/{quiz}/duplicate', [\App\Http\Controllers\Teacher\QuizController::class, 'duplicateForm'])->name('quizzes.duplicate');
    Route::post('/quizzes/{quiz}/duplicate', [\App\Http\Controllers\Teacher\QuizController::class, 'duplicate'])->name('quizzes.duplicate.store');
...
Route::middleware(['auth', 'role:student'])->prefix('student')->name('student.')->group(function () {
    ...
    Route::post('/profile/documents', [\App\Http\Controllers\Student\ProfileController::class, 'uploadDocument'])->name('profile.documents.upload');
