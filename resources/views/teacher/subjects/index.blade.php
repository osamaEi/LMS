...
@section('title', 'مقرارتي')

@section('content')
<div class="mb-6">
    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">مقرارتي</h1>
    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">عرض وإدارة المقررات  التدريبية  المسندة إليك</p>
</div>
...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full">
    ...
    <div class="rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900 overflow-hidden hover:shadow-lg transition-shadow">
        ...
        @else
        <div class="h-40 flex items-center justify-center" style="background: linear-gradient(135deg, #0071AA, #005a88);">
        ...
        <div class="p-5">
            ...
            <div class="flex items-center gap-4 mb-4 text-sm">
                ...
                <div class="flex items-center gap-1 text-gray-600 dark:text-gray-400">
                    ...
                    <span>{{ $subject->sessions_count }}  محاضرة </span>
                </div>
            </div>
    ...
    <div class="col-span-full">
        <div class="rounded-xl border border-gray-200 bg-white p-12 dark:border-gray-800 dark:bg-gray-900 text-center">
            ...
            <p class="mt-4 text-sm font-medium text-gray-900 dark:text-white">لا توجد مقرارت مسندة إليك</p>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">تواصل مع الإدارة لإسناد مقرارت دراسية</p>
        </div>
    </div>
    @endforelse
</div>
