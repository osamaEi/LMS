...
@section('title', 'الاختبارات - ' . $program->name)
    ...
    <div class="header-card">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
            <div class="flex items-center gap-5">
                <a href="{{ route('teacher.my-courses.show', $program->id) }}" class="back-btn">
    ...
    <div class="quizzes-card">
                    ...
                    <div class="quiz-item">
                        <div class="flex flex-col lg:flex-row lg:items-center gap-5">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <a href="{{ route('teacher.quizzes.program.results', [$program->id, $quiz->id]) }}"
                                   class="action-btn results-btn" title="النتائج">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                                    </svg>
                                </a>
                                <a href="{{ route('teacher.quizzes.program.edit', [$program->id, $quiz->id]) }}"
                                   class="action-btn edit-btn" title="تعديل">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                    </svg>
                                </a>
                                <form action="{{ route('teacher.quizzes.program.destroy', [$program->id, $quiz->id]) }}" method="POST" class="inline"
        ...
        @else
            ...
            <div class="empty-state">
                ...
                <p class="empty-text">
                    ابدأ بإنشاء أول اختبار لمادة <span class="font-semibold" style="color: #0071AA;">{{ $program->name }}</span>
                </p>
                <a href="{{ route('teacher.quizzes.create-global') }}" class="create-btn">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
