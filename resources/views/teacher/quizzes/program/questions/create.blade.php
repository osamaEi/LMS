...
<div class="space-y-6">
    ...
    <div class="page-header">
        <div class="relative z-10 flex items-center gap-4">
            <a href="{{ route('teacher.quizzes.program.show', [$program->id, $quiz->id]) }}" class="back-btn">
    ...
    <!-- Form -->
    <form action="{{ route('teacher.quizzes.program.questions.store', [$program->id, $quiz->id]) }}" method="POST" enctype="multipart/form-data" id="questionForm">
        @csrf
        ...
        <div class="form-card">
            ...
            <div class="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700 flex flex-wrap items-center justify-end gap-3">
                <a href="{{ route('teacher.quizzes.program.show', [$program->id, $quiz->id]) }}" class="btn btn-cancel">
                    إلغاء
                </a>
