...
<div class="page-container">
        ...
        <div class="relative z-10">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                <div class="flex items-start gap-4">
                    <a href="{{ route('teacher.quizzes.program.index', $program->id) }}" class="back-btn">
                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/>
                        </svg>
                    </a>
                    <div>
                        <p class="text-white/70 text-sm font-medium mb-1">{{ $program->name }}</p>
                ...
                <div class="header-actions">
                    ...
                    <a href="{{ route('teacher.quizzes.program.pdf', [$program->id, $quiz->id]) }}" class="header-btn as-button" style="text-decoration:none;">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                        </svg>
                        PDF (أسئلة)
                    </a>
                    <a href="{{ route('teacher.quizzes.program.pdf', [$program->id, $quiz->id]) }}?answers=1" class="header-btn as-button" style="text-decoration:none;">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="questions-card">
        ...
        <div id="addQuestionBox" class="inline-edit-box" style="display:none;margin:1rem 2rem;">
            ...
            <form method="POST" action="{{ route('teacher.quizzes.program.questions.store', [$program->id, $quiz->id]) }}" enctype="multipart/form-data"
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-start justify-between gap-4">
                                    ...
                                    <div class="question-actions view-mode" id="q-actions-{{ $question->id }}">
                                        ...
                                        <form action="{{ route('teacher.quizzes.program.questions.destroy', [$program->id, $quiz->id, $question->id]) }}" method="POST"
                                ...
                                <div class="edit-form" id="q-edit-{{ $question->id }}">
                                    <div class="inline-edit-box">
                                        ...
                                        <form method="POST" action="{{ route('teacher.quizzes.program.questions.update', [$program->id, $quiz->id, $question->id]) }}" enctype="multipart/form-data"
                                              oninput="syncQuestionType(this)">
                                            @csrf
                                            @method('PUT')
