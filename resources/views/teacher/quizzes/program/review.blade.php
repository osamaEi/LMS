...
<div class="space-y-6">
    ...
    <div class="space-y-5">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm overflow-hidden
            ...
            <div class="px-6 py-5">
                ...
                @if($needsGrade)
                <form action="{{ route('teacher.quizzes.program.submit-grade', [$program->id, $quiz->id, $attempt->id]) }}"
    ...
    <div class="flex items-center justify-between pt-2">
        ...
        <a href="{{ route('teacher.quizzes.program.grade-attempt', [$program->id, $quiz->id, $attempt->id]) }}"
