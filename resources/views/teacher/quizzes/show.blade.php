        ...
        <div class="relative z-10">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                ...
                <div class="header-actions">
                    ...
                    <a href="{{ route('teacher.quizzes.pdf', [$subject->id, $quiz->id]) }}" class="header-btn as-button" style="text-decoration:none;">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                        </svg>
                        PDF (أسئلة)
                    </a>
                    <a href="{{ route('teacher.quizzes.pdf', [$subject->id, $quiz->id]) }}?answers=1" class="header-btn as-button" style="text-decoration:none;">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
