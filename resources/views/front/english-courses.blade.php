...
$levelLabels = [
    0=>'التمهيديي',1=>'التأسيسي',2=>'المبتدئ',
...
<section class="eng-hero">
    <div class="inner">
        ...
        <p>{{ $programs->count() }} مستوى متدرّج مُصمَّم لجميع الفئات — من التمهيديي حتى المستوى الثاني عشر. كل مستوى مدته شهر واحد بـ 40 ساعة تدريبية.</p>
