...
@section('title', 'المسارات التدريبية  - أكاديميةالإرتقاء العالي للتدريب')
...
@endphp
    ...
    <section class="hero-section">
        ...
        <p>
            نوفر في أكاديميةنا منظومة تدريبية متكاملة مبنية على احتياجات سوق العمل السعودي وفق رؤية 2030،
            من خلال مسارات تدريبية تمتد لمدة سنتين ونصف (10 فصول تدريبية)،
            تُعدّ المتدربون  بخبرة عملية وعلمية تجعل مسيرتهم التعليمية واضحة وقوية وموجّهة نحو مهن المستقبل.
        </p>
    </section>
    ...
    <section class="courses-section">
        <div class="head">
            ...
            <p>
                مجموعة متنوعة من البرامج التأهيلية  المعتمدة المصممة لتلبية احتياجات سوق العمل.
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="content">
                    ...
                    <p>
                        تطبيق أكاديميةنا يمنحك وصولاً سريعاً ومباشراً لجميع المسارات التدريبية  والدورات.
                        تابع تقدمك، استقبل إشعارات المحاضرات، وتواصل مع المدربون بسهولة من أي مكان.
                    </p>
            ...
            <div class="col-lg-6 d-flex justify-content-center mt-4 mt-lg-0">
                @include('front.partials.cta-formal-image', ['src' => asset('new/1.png'), 'badgeText' => 'مسارات تأهيلية', 'badgeSub' => 'معتمدة من الجهات المختصة', 'tagText' => 'انضم الآن'])
            </div>
        </div>
    </section>
