    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-b-2xl shadow-xl p-8 space-y-8 policy-content">
            ...
            <section>
                <h2>1. المقدمة</h2>
                <p>
                    يعتمد أكاديمية الإرتقاء العالي للتدريب نظام حضور إلكتروني متكامل يضمن متابعة انتظام المتدربون  في برامجهم التدريبية . تم إعداد هذه السياسة بما يتوافق مع معايير المركز الوطني للتعليم الإلكتروني (NELC) ومتطلبات المؤسسة العامة للتدريب التقني والمهني لضمان جودة العملية التعليمية.
                </p>
                <div class="info-box">
            ...
            <section>
                ...
                <ul>
                    ...
                    <li><strong>المدرب:</strong> تسجيل الحضور بدقة، ومتابعة نسب الغياب، والتواصل مع المتدربون  المتغيبين</li>
