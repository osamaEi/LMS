    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-b-2xl shadow-xl p-8 space-y-8 policy-content">
            ...
            <section>
                <h2>1. المقدمة</h2>
                <p>
                    يوفر معهد الإرتقاء العالي للتدريب منظومة دعم فني شاملة تهدف إلى تقديم المساعدة لجميع مستخدمي المنصة التعليمية وحل المشكلات التقنية بكفاءة وسرعة. نسعى لضمان تجربة تعليمية سلسة من خلال توفير قنوات دعم متعددة وفريق متخصص على مدار الساعة.
                </p>
            </section>
