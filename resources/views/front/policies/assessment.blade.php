    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-b-2xl shadow-xl p-8 space-y-8 policy-content">
            ...
            <section>
                <h2>1. المقدمة</h2>
                <p>
                    يتبنى معهد الارتقاء العالي للتدريب نظام تقييم شامل وعادل يهدف إلى قياس مدى تحقيق المتدربون  لمخرجات التعلم المستهدفة. يعتمد نظام التقييم على التنويع في أساليب وأدوات التقييم لضمان شموليته ودقته، بما يتوافق مع معايير المركز الوطني للتعليم الإلكتروني ومتطلبات ضمان الجودة.
                </p>
            </section>
