            ...
            <div style="display: flex; align-items: flex-start; gap: 1.25rem;">
                ...
                <div style="flex: 1;">
                    <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1rem;">
                        ...
                        <div>
                            <h2 style="font-size: 1.25rem; font-weight: 700; color: #111827; margin: 0;">اختيار الدورات التدريبي ة</h2>
                            <p style="color: #6b7280; font-size: 0.875rem; margin: 0.25rem 0 0 0;">تصفح واختر الدورات المناسبة لأهدافك التعليمية</p>
                        </div>
                    </div>
                    <div style="color: #374151; line-height: 1.9; font-size: 0.95rem;">
                        <p style="margin-bottom: 1rem;">توفر المنصة مجموعة متنوعة من الدورات التدريبي ة والدبلومات    التعليمية المعتمدة. لاختيار الدورة المناسبة:</p>
                        <div class="sub-step" style="margin-bottom: 0.75rem;">
                            <strong>تصفح كتالوج الدورات:</strong> من لوحة التحكم الخاصة بك، انتقل إلى قسم "الدبلومات    التدريبي ة" أو "الدورات" لاستعراض جميع الدورات المتاحة.
                        </div>
                        <div class="sub-step" style="margin-bottom: 0.75rem;">
                        ...
                        <div class="sub-step" style="margin-bottom: 0.75rem;">
                            <strong>اطلع على تفاصيل الدورة:</strong> قبل التسجيل، اضغط على بطاقة الدورة لمعرفة الوصف التفصيلي، والأهداف التعليمية، ومتطلبات الدورة، واسم المدرب، وعدد الساعات التدريبي ة.
                        </div>
                        <div class="sub-step" style="margin-bottom: 0.75rem;">
