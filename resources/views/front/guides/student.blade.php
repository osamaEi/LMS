            ...
            <div style="display: flex; align-items: flex-start; gap: 1.25rem;">
                ...
                <div style="flex: 1;">
                    ...
                    <div style="color: #374151; line-height: 1.9; font-size: 0.95rem;">
                        ...
                        <div class="sub-step" style="margin-bottom: 0.75rem;">
                            <strong>أدخل بيانات الاعتماد:</strong> قم بإدخال اسم المستخدم أو البريد الإلكتروني وكلمة المرور اللذين تم تزويدك بهما عند التسجيل في الأكاديمية .
                        </div>
                        <div class="sub-step" style="margin-bottom: 0.75rem;">
        ...
        <div class="step-card" style="background: #fff; border-radius: 1rem; padding: 2rem; margin-bottom: 1.5rem;">
            <div style="display: flex; align-items: flex-start; gap: 1.25rem;">
                ...
                <div style="flex: 1;">
                    ...
                    <div style="color: #374151; line-height: 1.9; font-size: 0.95rem;">
                        <p style="margin-bottom: 1rem;">توفر المنصة مجموعة متنوعة من الدورات التدريبية  والدبلومات    التعليمية المعتمدة. لاختيار الدورة المناسبة:</p>
                        <div class="sub-step" style="margin-bottom: 0.75rem;">
                            <strong>تصفح كتالوج الدورات:</strong> من لوحة التحكم الخاصة بك، انتقل إلى قسم "الدبلومات    التدريبية " أو "الدورات" لاستعراض جميع الدورات المتاحة.
                        </div>
                        <div class="sub-step" style="margin-bottom: 0.75rem;">
            ...
            <div style="display: flex; align-items: flex-start; gap: 1.25rem;">
                ...
                <div style="flex: 1;">
                    ...
                    <div style="color: #374151; line-height: 1.9; font-size: 0.95rem;">
                        ...
                        <div class="sub-step" style="margin-bottom: 0.75rem;">
                            <strong>اقرأ المقررات  المرفقة:</strong> لكل درس مقرارت تعليمية مرفقة (ملفات PDF أو عروض تقديمية). قم بتحميلها ومراجعتها لتعزيز فهمك للموضوع.
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div style="flex: 1;">
                    <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1rem;">
                        ...
                        <div>
                            ...
                            <p style="color: #6b7280; font-size: 0.875rem; margin: 0.25rem 0 0 0;">حضور المحاضرات المباشرة والتفاعل مع المدرب</p>
                        </div>
                    </div>
                    <div style="color: #374151; line-height: 1.9; font-size: 0.95rem;">
                        ...
                        <div class="sub-step" style="margin-bottom: 0.75rem;">
                            <strong>التفاعل أثناء ال محاضرة :</strong> يمكنك رفع يدك للسؤال، واستخدام المحادثة النصية (Chat) لطرح الأسئلة، ومشاركة شاشتك عند الحاجة. كما يمكنك المشاركة في الاستطلاعات والأنشطة التفاعلية.
                        </div>
                        <div class="sub-step" style="margin-bottom: 0.75rem;">
            ...
            <div style="display: flex; align-items: flex-start; gap: 1.25rem;">
                ...
                <div style="flex: 1;">
                    ...
                    <div style="color: #374151; line-height: 1.9; font-size: 0.95rem;">
                        ...
                        <div class="sub-step" style="margin-bottom: 0.75rem;">
                            <strong>الإشعارات والتنبيهات:</strong> فعّل الإشعارات لتصلك تنبيهات حول مواعيد التسليم القادمة، والمحاضرات المباشرة، وأي تحديثات جديدة في الدورة.
                        </div>
                    </div>
                </div>
            </div>
