            ...
            <div style="display: flex; align-items: flex-start; gap: 1.25rem;">
                ...
                <div style="flex: 1;">
                    ...
                    <div style="color: #374151; line-height: 1.9; font-size: 0.95rem;">
                        ...
                        <div class="sub-step" style="margin-bottom: 0.75rem;">
                            <strong>تصفح كتالوج الدورات:</strong> من لوحة التحكم الخاصة بك، انتقل إلى قسم "الدبلومات  التدريبية" أو "الدورات القصيرة" لاستعراض جميع الدورات المتاحة.
                        </div>
                        <div class="sub-step" style="margin-bottom: 0.75rem;">
            ...
            <div style="display: flex; align-items: flex-start; gap: 1.25rem;">
                ...
                <div style="flex: 1;">
                    ...
                    <div style="color: #374151; line-height: 1.9; font-size: 0.95rem;">
                        ...
                        <div class="sub-step" style="margin-bottom: 0.75rem;">
                            <strong>اقرأ المقررات  المرفقة:</strong> لكل درس مواد تعليمية مرفقة (ملفات PDF أو عروض تقديمية). قم بتحميلها ومراجعتها لتعزيز فهمك للموضوع.
                        </div>
                    </div>
                </div>
            </div>
