        ...
        <div class="guide-header-gradient" style="border-radius: 1rem; padding: 2.5rem; color: #fff; margin-bottom: 2rem; position: relative; overflow: hidden;">
            ...
            <div style="position: relative; z-index: 1;">
                ...
                <p style="font-size: 0.95rem; opacity: 0.85; line-height: 1.8; margin: 0;">
                    يهدف هذا الدليل إلى تمكين المدربون والمدربون  من استخدام جميع أدوات المنصة التعليمية بكفاءة عالية، بدءاً من إنشاء المحتوى التعليمي
                    وحتى تقييم المتدربون  ومتابعة تقدمهم. نرجو مراجعة الخطوات التالية لضمان تقديم تجربة تعليمية متميزة.
                </p>
            </div>
            ...
            <div style="display: flex; align-items: flex-start; gap: 1.25rem;">
                ...
                <div style="flex: 1;">
                    ...
                    <div style="color: #374151; line-height: 1.9; font-size: 0.95rem;">
                        ...
                        <div class="sub-step" style="margin-bottom: 0.75rem;">
                            <strong>إدخال بيانات الاعتماد:</strong> أدخل البريد الإلكتروني المؤسسي وكلمة المرور المخصصة لحسابك ك مدرب . هذه البيانات يتم تزويدك بها من قبل إدارة الأكاديمية عند تعيينك.
                        </div>
                        <div class="sub-step" style="margin-bottom: 0.75rem;">
            ...
            <div style="display: flex; align-items: flex-start; gap: 1.25rem;">
                ...
                <div style="flex: 1;">
                    ...
                    <div style="color: #374151; line-height: 1.9; font-size: 0.95rem;">
                        ...
                        <div class="sub-step" style="margin-bottom: 0.75rem;">
                            <strong>تحديد إعدادات الدورة:</strong> حدد تاريخ بدء الدورة وانتهائها، ونوع التسجيل (مفتوح أو بموافقة ال مدرب )، والحد الأقصى لعدد المتدربون ، ومتطلبات إكمال الدورة (مثل نسبة الحضور والدرجة الدنيا للنجاح).
                        </div>
                        <div class="sub-step" style="margin-bottom: 0.75rem;">
        ...
        <div class="step-card" style="background: #fff; border-radius: 1rem; padding: 2rem; margin-bottom: 1.5rem;">
            <div style="display: flex; align-items: flex-start; gap: 1.25rem;">
                ...
                <div style="flex: 1;">
                    ...
                    <div style="color: #374151; line-height: 1.9; font-size: 0.95rem;">
                        <p style="margin-bottom: 1rem;">تمكّنك الفصول الافتراضية من تقديم محاضرات تدريبية مباشرة بتفاعل حقيقي مع المتدربون :</p>
                        <div class="sub-step" style="margin-bottom: 0.75rem;">
                        ...
                        <div class="sub-step" style="margin-bottom: 0.75rem;">
                            <strong>إعداد الجلسة:</strong> قبل موعد الجلسة، تأكد من تجهيز المقررات  التعليمية والعروض التقديمية التي ستحتاجها. اختبر الكاميرا والميكروفون واتصال الإنترنت للتأكد من جودة البث.
                        </div>
                        <div class="sub-step" style="margin-bottom: 0.75rem;">
                            <strong>بدء الجلسة وإدارتها:</strong> ادخل إلى الفصل الافتراضي قبل الموعد بعشر دقائق. خلال الجلسة يمكنك: مشاركة شاشتك لعرض المحتوى، واستخدام السبورة البيضاء التفاعلية للشرح، وإطلاق استطلاعات رأي فورية، وتقسيم المتدربون  إلى مجموعات عمل (Breakout Rooms).
                        </div>
                        <div class="sub-step" style="margin-bottom: 0.75rem;">
                            <strong>تسجيل الحضور:</strong> يتم تسجيل حضور المتدربون  تلقائياً عند دخولهم الفصل الافتراضي. يمكنك مراجعة سجل الحضور بعد انتهاء الجلسة من قسم التقارير.
                        </div>
                        <div class="sub-step" style="margin-bottom: 0.75rem;">
                        ...
                        <div style="background: #eff6ff; border-radius: 0.5rem; padding: 0.75rem 1rem; margin-top: 0.75rem; display: flex; align-items: flex-start; gap: 0.5rem;">
                            ...
                            <span style="font-size: 0.875rem; color: #1e40af;"><strong>نصيحة:</strong> حافظ على تفاعل المتدربون  من خلال طرح أسئلة دورية، واستخدام الأنشطة التفاعلية كل 10-15 دقيقة لكسر رتابة المحاضرة.</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div style="flex: 1;">
                    ...
                    <div style="color: #374151; line-height: 1.9; font-size: 0.95rem;">
                        ...
                        <div style="background: #fff7ed; border-radius: 0.75rem; padding: 1.25rem;">
                            ...
                            <div class="sub-step" style="margin-bottom: 0.75rem;">
                                <strong>تصحيح الواجبات:</strong> بعد تسليم المتدربون  لواجباتهم، انتقل إلى قسم "التسليمات" لمراجعة كل واجب. يمكنك تحميل الملف المرفق، ومنح الدرجة، وكتابة ملاحظات تفصيلية للمتدرب حول نقاط القوة ومجالات التحسين.
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div style="display: flex; align-items: flex-start; gap: 1.25rem;">
                ...
                <div style="flex: 1;">
                    <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1rem;">
                        ...
                        <div>
                            <h2 style="font-size: 1.25rem; font-weight: 700; color: #111827; margin: 0;">الرد على استفسارات المتدربون </h2>
                            <p style="color: #6b7280; font-size: 0.875rem; margin: 0.25rem 0 0 0;">التواصل الفعال وتقديم الدعم المستمر</p>
                        </div>
                    </div>
                    <div style="color: #374151; line-height: 1.9; font-size: 0.95rem;">
                        <p style="margin-bottom: 1rem;">يُعد التواصل مع المتدربون  والرد على استفساراتهم من أهم عوامل نجاح العملية التعليمية. توفر المنصة قنوات متعددة لذلك:</p>
                        <div class="sub-step" style="margin-bottom: 0.75rem;">
                            <strong>منتديات النقاش:</strong> تابع منتدى النقاش الخاص بكل دورة بشكل دوري. قم بالرد على أسئلة المتدربون  خلال 24 ساعة كحد أقصى. شجّع الحوار البنّاء بين المتدربون  وأضف قيمة علمية في كل مشاركة.
                        </div>
                        <div class="sub-step" style="margin-bottom: 0.75rem;">
                        ...
                        <div class="sub-step" style="margin-bottom: 0.75rem;">
                            <strong>ساعات الإرشاد المكتبية:</strong> خصص ساعات محددة أسبوعياً لعقد جلسات إرشاد افتراضية فردية أو جماعية مع المتدربون  الذين يحتاجون إلى دعم إضافي. أعلن عن هذه المواعيد في صفحة الدورة.
                        </div>
                        <div class="sub-step" style="margin-bottom: 0.75rem;">
                            <strong>التغذية الراجعة البنّاءة:</strong> عند تقييم أعمال المتدربون ، احرص على تقديم تغذية راجعة تفصيلية وبنّاءة تساعدهم على التحسن. وضّح نقاط القوة قبل مجالات التطوير، وقدّم توجيهات عملية واضحة.
                        </div>
        ...
        <div style="background: #fff; border-radius: 1rem; padding: 2rem; margin-bottom: 1.5rem; border: 1px solid #e5e7eb;">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 1rem;">
                <div style="background: #fefce8; border-radius: 0.75rem; padding: 1rem 1.25rem;">
                    ...
                    <p style="color: #4b5563; font-size: 0.875rem; line-height: 1.7; margin: 0;">ابدأ المحاضرات في مواعيدها وأعلن عن الاختبارات مبكراً. الالتزام يبني الثقة ويعزز احترام المتدربون .</p>
                </div>
                <div style="background: #fefce8; border-radius: 0.75rem; padding: 1rem 1.25rem;">
                    <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.5rem;">
                ...
                <div style="background: #fefce8; border-radius: 0.75rem; padding: 1rem 1.25rem;">
                    ...
                    <p style="color: #4b5563; font-size: 0.875rem; line-height: 1.7; margin: 0;">استخدم مزيجاً من الفيديوهات والأنشطة التفاعلية والمناقشات لتلبية أنماط التعلم المختلفة لدى المتدربون .</p>
                </div>
            </div>
        </div>
