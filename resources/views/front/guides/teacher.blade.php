            ...
            <div style="display: flex; align-items: flex-start; gap: 1.25rem;">
                ...
                <div style="flex: 1;">
                    <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1rem;">
                        ...
                        <div>
                            <h2 style="font-size: 1.25rem; font-weight: 700; color: #111827; margin: 0;">إنشاء الدورات التدريبي ة وإدارتها</h2>
                    ...
                    <div style="color: #374151; line-height: 1.9; font-size: 0.95rem;">
                        ...
                        <div class="sub-step" style="margin-bottom: 0.75rem;">
                            <strong>إنشاء دورة جديدة:</strong> من لوحة تحكم المعلم، انتقل إلى قسم "إدارة الدورات" واضغط على "إنشاء دورة جديدة". قم بتعبئة المعلومات الأساسية مثل: اسم الدورة، والوصف التفصيلي، والأهداف التعليمية، ومتطلبات الالتحاق، وعدد الساعات التدريبي ة.
                        </div>
                        <div class="sub-step" style="margin-bottom: 0.75rem;">
