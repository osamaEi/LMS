        ...
        <div class="p-5">
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-4">
                ...
                <div class="flex items-start gap-2.5">
                    ...
                    <div>
                        <div class="text-[0.7rem] text-gray-400 font-medium">التخصص</div>
                ...
                <div class="flex items-start gap-2.5">
                    ...
                    <div>
                        <div class="text-[0.7rem] text-gray-400 font-medium">نوع التخصص</div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="d-card">
            <div class="d-card-head">
                ...
                <span class="text-sm font-bold text-gray-900 dark:text-white flex-1">تقييم ال مدرب ين</span>
