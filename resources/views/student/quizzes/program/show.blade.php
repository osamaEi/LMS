                            ...
                            <tr>
                                ...
                                <td class="py-3 px-4">
                                    @if($attempt->isCompleted() && $quiz->show_results)
                                        <a href="{{ route('student.quizzes.program.result', [$program->id, $quiz->id, $attempt->id]) }}"
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-6">
                @if($activeAttempt)
                    <div class="text-center">
                        ...
                        <a href="{{ route('student.quizzes.program.take', [$program->id, $quiz->id]) }}"
                ...
                @else
                    <div class="text-center">
                        ...
                        <form action="{{ route('student.quizzes.program.start', [$program->id, $quiz->id]) }}" method="POST">
                            @csrf
                            <button type="submit"
                                    class="block w-full py-3 px-4 rounded-xl font-bold text-white text-center transition-all"
