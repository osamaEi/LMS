...
<style>
    ...
    .dark .subject-grade-item { border-color: #1f2937; }
    .subject-grade-item:hover { background: #f8fafc; }
    .dark .subject-grade-item:hover { background: #111827; }
    ...
    .dark .subject-teacher { color: #9ca3af; }
...
<div class="grades-page space-y-6">
    ...
    <div class="grades-header">
        <div class="flex items-center gap-4 relative z-10">
            ...
            <div>
                <h1 class="text-2xl font-extrabold">الدرجات والتقييمات</h1>
                <p class="opacity-75 text-sm mt-0.5">متابعة درجاتك في جميع المواد</p>
            </div>
        </div>
    </div>
    ...
    <div class="grades-card">
        ...
        <div class="empty-state">
            ...
            <h3 class="empty-title">لا توجد درجات حتى الآن</h3>
            <p class="empty-desc">
                سيتم عرض درجاتك هنا بعد انتهاء الاختبارات والتقييمات.
        ...
        <div class="p-6">
            <div class="space-y-4 text-sm text-gray-600 dark:text-gray-400">
                <div class="flex items-start gap-3">
                    ...
                    <p>يتم تحديث الدرجات بعد كل اختبار أو تقييم من قبل المعلم</p>
                </div>
                <div class="flex items-start gap-3">
                    <div class="w-6 h-6 rounded-full bg-emerald-100 dark:bg-emerald-900/30 flex items-center justify-center flex-shrink-0 mt-0.5">
                        <svg class="w-3.5 h-3.5 text-emerald-600" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <p>الحضور المنتظم يؤثر إيجابياً على درجاتك النهائية</p>
                </div>
                <div class="flex items-start gap-3">
                    <div class="w-6 h-6 rounded-full bg-emerald-100 dark:bg-emerald-900/30 flex items-center justify-center flex-shrink-0 mt-0.5">
                        <svg class="w-3.5 h-3.5 text-emerald-600" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <p>للاستفسار عن درجاتك، يمكنك التواصل مع معلم المادة</p>
                </div>
            </div>
        </div>
    </div>
