...
@section('title', 'الجدول التدريبي')

@php
$calSessions = $calSessions ?? collect();
$stats       = $stats ?? ['total'=>0,'upcoming'=>0,'completed'=>0,'live'=>0];
@endphp
    ...
    <div style="position:relative;z-index:1;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:16px;">
        <div style="display:flex;align-items:center;gap:14px;">
            ...
            <div>
                ...
                <h1 style="color:white;font-size:20px;font-weight:700;margin:0;">جدولي التدريبي</h1>
            </div>
        </div>
...
function openSession(s){
    ...
    const rows=[
        s.scheduled_at?['📅 الموعد', new Date(s.scheduled_at).toLocaleDateString('ar-SA',{weekday:'long',year:'numeric',month:'long',day:'numeric'})+' — '+fmtTime(s.scheduled_at)]:null,
