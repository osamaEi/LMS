    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm overflow-hidden">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">{{ $programs->total() }} دبلوم تعليمي</p>
                    </div>
                </div>
            ...
            <table class="data-table w-full">
                <thead>
                    <tr class="bg-gray-50 dark:bg-gray-700/50">
                        ...
                        <th class="px-6 py-4 text-right text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">الدبلوم</th>
                    ...
                    <tr class="table-row" data-status="{{ $program->status }}" data-name="{{ $program->name_ar }} {{ $program->name_en }}">
                        ...
                        <td class="px-6 py-5">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-xs text-gray-500 dark:text-gray-400">دبلوم</span>
                            </div>
                        </td>
                        <td class="px-6 py-5">
                            <div class="flex items-center gap-2">
                        ...
                        <td class="px-6 py-5">
                            <div class="flex items-center justify-center gap-1">
                                ...
                                <form action="{{ route('admin.programs.destroy', $program) }}" method="POST" class="inline"
                                      onsubmit="return confirm('هل أنت متأكد من حذف هذا الدبلوم؟ سيتم حذف جميع البيانات المرتبطة به.')">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit"
        ...
        <div class="p-16 text-center">
            ...
            <p class="text-gray-500 dark:text-gray-400 max-w-md mx-auto mb-6">
                ابدأ بإضافة دبلوم تعليمي جديد لتنظيم المقررات  والبرامج التدريبي ة في نظامك التعليمي.
            </p>
            <a href="{{ route('admin.programs.create') }}"
