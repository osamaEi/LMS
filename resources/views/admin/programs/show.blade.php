...
<div x-data="{}">
        ...
        <div class="flex-1 min-w-[160px] bg-white dark:bg-gray-800 rounded-xl p-5 border border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <div class="text-sm text-gray-600 dark:text-gray-400 mt-1">الأرباع التدريبي ة</div>
                </div>
        ...
        <div class="flex-1 min-w-[160px] bg-white dark:bg-gray-800 rounded-xl p-5 border border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <div class="text-sm text-gray-600 dark:text-gray-400 mt-1">المقررات  التدريبي ة</div>
                </div>
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
                <div class="p-6 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between">
                    <h2 class="text-lg font-bold text-gray-900 dark:text-white">الأرباع التدريبي ة ({{ $program->terms->count() }})</h2>
                    <button @click="$store.termModal = true"
                        ...
                        <div class="flex items-start justify-between">
                            <div class="flex-1">
                                ...
                                <div class="mt-4 pt-4 border-t border-gray-100 dark:border-gray-800">
                                    <p class="text-xs font-medium text-gray-500 dark:text-gray-400 mb-2">المقررات  التدريبي ة:</p>
