    ...
    <div style="display:flex;align-items:center;justify-content:space-between;padding:14px 20px;background:linear-gradient(135deg,#f8fafc,#f1f5f9);border-bottom:1px solid #e2e8f0;">
        ...
        <div style="display:flex;align-items:center;gap:6px;">
            ...
            <form method="POST" action="{{ route('admin.terms.destroy', $term) }}"
                  onsubmit="return confirm('حذف الربع «{{ addslashes($term->name) }}» وكل مقرراته؟')">
                @csrf @method('DELETE')
                <button type="submit"
                        style="display:flex;align-items:center;justify-content:center;width:32px;height:32px;border-radius:9px;border:1.5px solid #fecaca;background:#fff1f2;color:#ef4444;cursor:pointer;" title="حذف الربع">
