...
<div class="mb-6">
    ...
    <p class="text-sm text-gray-500 dark:text-gray-400">أدخل بيانات الدبلوم والأرباع التدريبي ة وقم بتعيين المقررات  في خطوة واحدة</p>
</div>
        ...
        <div class="p-5 border-b border-gray-200 dark:border-gray-800" style="background: linear-gradient(135deg,#7c3aed,#5b21b6); border-radius: 12px 12px 0 0;">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <h2 class="text-base font-bold text-white">الأرباع التدريبي ة والمقررات </h2>
                </div>
    ...
    return `
        ...
        <div>
            <div class="flex items-center justify-between mb-2">
                <label class="block text-xs font-medium text-gray-600 dark:text-gray-400">المقررات  التدريبي ة <span id="selectedCount_${idx}" class="text-purple-600 font-bold">(0 محدد)</span></label>
