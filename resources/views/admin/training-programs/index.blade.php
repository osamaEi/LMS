        ...
        <div class="relative z-10">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                <div class="flex items-center gap-5">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-white">البرامج التأهيلية </h1>
                        <p class="mt-1 text-white/70">إدارة وتنظيم جميع البرامج التأهيلية </p>
                    </div>
                </div>
        ...
        <div class="p-6 border-b border-gray-100 dark:border-gray-700">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h2 class="text-xl font-bold text-gray-900 dark:text-white">قائمة البرامج التأهيلية </h2>
