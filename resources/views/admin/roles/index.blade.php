...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">إدارة الأدوار</h1>
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">إنشاء وتعديل أدوار المستخدمين وصلاحياتهم</p>
            </div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="text-xs text-gray-500 dark:text-gray-400">Guard: {{ $role->guard_name }}</div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4">
                            <div class="flex flex-wrap gap-1">
                                ...
                                @empty
                                <span class="text-xs text-gray-500 dark:text-gray-400">لا توجد صلاحيات</span>
                                @endforelse
                    ...
                    <tr>
                        <td colspan="5" class="px-6 py-12 text-center">
                            <div class="flex flex-col items-center">
                                ...
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">ابدأ بإنشاء دور جديد</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
