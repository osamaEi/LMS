...
@section('title', 'تقرير تقييمات المدربون ')
...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">تقرير تقييمات المدربون </h2>
            <p class="text-gray-600 dark:text-gray-400">إحصائيات شاملة عن تقييمات المدربون  (معيار NELC 2.4.9)</p>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">أفضل المدربون  تقييماً</h3>
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr>
                        <td colspan="5" class="px-6 py-12 text-center text-gray-500 dark:text-gray-400">
                            ...
                            <p class="mt-2">لا يوجد  مدربون لديهم 3 تقييمات أو أكثر</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
