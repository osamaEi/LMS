    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <nav class="flex items-center text-sm text-gray-500 dark:text-gray-400 mb-4">
                ...
                <span class="mx-2">/</span>
                <span class="text-gray-900 dark:text-white">إنشاء صلاحية جديدة</span>
            </nav>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">إنشاء صلاحية جديدة</h1>
        </div>
            ...
            <form action="{{ route('admin.permissions.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text"
                           ...
                           placeholder="مثال: create-users, edit-posts, delete-comments"
                           required>
                    @error('name')
                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                    <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
                        استخدم تنسيق: action-resource مثل: create-users, view-reports, manage-settings
                    </p>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="flex flex-wrap gap-2">
                        @foreach(['view-dashboard', 'manage-users', 'create-posts', 'edit-posts', 'delete-posts', 'manage-settings', 'view-reports'] as $suggestion)
                        <button type="button"
                                onclick="document.getElementById('name').value = '{{ $suggestion }}'"
                                class="px-3 py-1 text-xs bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-full transition">
                            {{ $suggestion }}
                        </button>
                        @endforeach
                    </div>
