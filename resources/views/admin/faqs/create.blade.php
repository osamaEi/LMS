...
<div class="p-6 max-w-4xl mx-auto">
    ...
    <div class="form-hero p-5 mb-6 text-white">
        <div class="relative z-10 flex items-center gap-4">
            ...
            <div>
                <h1 class="text-xl font-bold">إضافة سؤال شائع</h1>
                <p class="text-blue-200 text-xs mt-0.5">أدخل السؤال والإجابة ثم احفظ ليظهر في صفحة الأسئلة الشائعة</p>
            </div>
        </div>
    </div>
            ...
            <div class="section-body space-y-4">
                <div>
                    ...
                    <textarea name="answer_ar" rows="5"
                              ...
                              placeholder="اكتب الإجابة بالعربية...">{{ old('answer_ar') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="answer_en" rows="4"
                              class="form-input"
                              placeholder="Write answer in English..." dir="ltr">{{ old('answer_en') }}</textarea>
                </div>
            </div>
        </div>
