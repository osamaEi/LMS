...
<div style="direction:rtl; font-family:'Segoe UI',sans-serif;">
    ...
    <div style="background:linear-gradient(135deg,#0f172a 0%,#1e293b 40%,#0f172a 100%);border-radius:20px;padding:36px 32px;margin-bottom:28px;position:relative;overflow:hidden;">
        ...
        <div style="position:relative;z-index:1;display:grid;grid-template-columns:repeat(6,1fr);gap:12px;margin-top:28px;">
            @php
                $heroStats = [
                    ['label'=>' المتدربون ','value'=>number_format($stats['total_students']),'icon'=>'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z','grad'=>'#6366f1,#8b5cf6'],
    ...
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:18px;margin-bottom:24px;">
        ...
        $reportCards = [
            ...
            [
                'title'  => 'تقرير تقدم  المتدربون ',
                'desc'   => 'تتبع التسجيل، الحضور، درجات الاختبارات، والتقدم العام للطلاب عبر جميع البرامج والمقررات .',
            ...
            [
                ...
                'desc'   => 'نظرة شاملة على درجات  المتدربون ، نتائج الاختبارات، أداء التقييمات، وتحليلات التقييم.',
            ...
            [
                'title'  => 'أداء ال مدرب ين',
                'desc'   => 'تقييم تقييمات ال مدرب ين، ملاحظات  المتدربون ، مقاييس فاعلية التدريس، وتحليلات الأداء.',
