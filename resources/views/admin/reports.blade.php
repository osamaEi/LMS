        ...
        <div class="space-y-3">
            <a href="#" class="flex items-center justify-between rounded-lg border border-gray-200 p-4 hover:bg-gray-50 dark:border-gray-800 dark:hover:bg-gray-800">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-sm font-medium text-gray-900 dark:text-white">تقرير المدربين </p>
                        <p class="text-xs text-gray-500 dark:text-gray-400">إحصائيات شاملة عن المدربين </p>
                    </div>
                </div>
