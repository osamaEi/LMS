        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div>
                ...
                <select name="type"
                        required
                        class="w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-gray-900 focus:border-brand-500 focus:ring-2 focus:ring-brand-500 dark:border-gray-700 dark:bg-gray-800 dark:text-white">
                    <option value="recorded_video" {{ old('type') === 'recorded_video' ? 'selected' : '' }}>فيديو مسجل</option>
                    <option value="live_zoom" {{ old('type') === 'live_zoom' ? 'selected' : '' }}>Zoom مباشر</option>
                </select>
            </div>
    ...
    <div class="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900 mb-6">
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div class="md:col-span-2">
                ...
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">رابط يوتيوب، Vimeo، أو أي رابط خارجي</p>
            </div>
            ...
            <div>
                ...
                <select name="video_platform"
                    ...
                    <option value="local" {{ old('video_platform') === 'local' ? 'selected' : '' }}>ملف محلي</option>
                </select>
            </div>
        </div>
    </div>
