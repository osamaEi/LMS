    ...
    <div style="position:relative;z-index:1;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:1.5rem;">
        <div style="display:flex;align-items:center;gap:1.25rem;">
            ...
            <div>
                ...
                <p style="color:rgba(255,255,255,.65);font-size:.9rem;margin:.3rem 0 0;">مرحباً بك في أكاديميةالارتقاء، <strong style="color:rgba(255,255,255,.9);">{{ auth()->user()->name }}</strong></p>
            </div>
        </div>
