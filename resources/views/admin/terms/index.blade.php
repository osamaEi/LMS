...
@section('title', 'إدارة الأرباع التدريبي ة')
...
<div style="direction:rtl; font-family:'Segoe UI',sans-serif;">
    ...
    <div style="background:linear-gradient(135deg,#4f46e5 0%,#7c3aed 50%,#6d28d9 100%);border-radius:20px;padding:36px 32px;margin-bottom:28px;position:relative;overflow:hidden;">
        ...
        <div style="position:relative;z-index:1;display:flex;align-items:flex-start;justify-content:space-between;flex-wrap:wrap;gap:20px;">
            <div>
                <div style="display:flex;align-items:center;gap:12px;margin-bottom:8px;">
                    ...
                    <div>
                        <h1 style="color:white;font-size:24px;font-weight:700;margin:0;">الأرباع التدريبي ة</h1>
                        <p style="color:rgba(255,255,255,0.75);font-size:14px;margin:2px 0 0;">إدارة جميع الأرباع التدريبي ة في النظام</p>
                    </div>
                </div>
            </div>
        ...
        <div style="position:relative;z-index:1;display:grid;grid-template-columns:repeat(4,1fr);gap:14px;margin-top:28px;">
            @php
                $statItems = [
                    ['label'=>'إجمالي الأرباع','value'=>$stats['total'],'icon'=>'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z','bg'=>'rgba(255,255,255,0.18)'],
                    ['label'=>'أرباع نشطة','value'=>$stats['active'],'icon'=>'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z','bg'=>'rgba(167,243,208,0.25)'],
                    ['label'=>'أرباع قادمة','value'=>$stats['upcoming'],'icon'=>'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z','bg'=>'rgba(147,197,253,0.25)'],
                    ['label'=>'أرباع مكتملة','value'=>$stats['completed'],'icon'=>'M5 13l4 4L19 7','bg'=>'rgba(255,255,255,0.1)'],
                ];
            @endphp
                    ...
                    <tr>
                        <td colspan="6" style="padding:60px 20px;text-align:center;">
                            <div style="display:flex;flex-direction:column;align-items:center;gap:12px;">
                                ...
                                @else
                                <a href="{{ route('admin.terms.create') }}" style="margin-top:4px;padding:8px 18px;background:#4f46e5;color:white;border-radius:10px;font-size:13px;text-decoration:none;">إضافة ربع دراسي</a>
                                @endif
                            </div>
                        </td>
                    </tr>
