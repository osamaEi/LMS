...
<div class="mb-6 flex items-center justify-between">
    <div>
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">الفصول الدراسية</h1>
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">إدارة جميع الفصول الدراسية في النظام</p>
    </div>
        ...
        <table class="w-full">
            <thead>
                <tr class="border-b border-gray-200 bg-gray-50 dark:border-gray-800 dark:bg-gray-800">
                    ...
                    <th class="px-6 py-4 text-right text-sm font-semibold text-gray-700 dark:text-gray-300">اسم الفصل</th>
                    <th class="px-6 py-4 text-right text-sm font-semibold text-gray-700 dark:text-gray-300">المسار</th>
                    <th class="px-6 py-4 text-right text-sm font-semibold text-gray-700 dark:text-gray-300">التاريخ</th>
                    <th class="px-6 py-4 text-right text-sm font-semibold text-gray-700 dark:text-gray-300">المواد</th>
            ...
            <tbody>
                ...
                <tr class="border-b border-gray-200 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                    ...
                    <td class="px-6 py-4">
                        <div class="text-sm font-medium text-gray-900 dark:text-white">{{ $term->name }}</div>
                        <div class="text-xs text-gray-500 dark:text-gray-400">الفصل {{ $term->term_number }}</div>
                    </td>
                    <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-100">{{ $term->program->name ?? '-' }}</td>
                    <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-100">
                        {{ $term->start_date->format('Y/m/d') }}<br>
                        <span class="text-xs text-gray-500">إلى {{ $term->end_date->format('Y/m/d') }}</span>
                    </td>
                    <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-100">
                        <span class="rounded-full bg-gray-100 px-3 py-1 text-xs font-medium dark:bg-gray-800">
                            {{ $term->subjects_count }} مادة
                        </span>
                    </td>
                ...
                <tr>
                    <td colspan="7" class="px-6 py-12 text-center">
                        <div class="flex flex-col items-center justify-center">
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">ابدأ بإضافة فصل دراسي جديد</p>
                        </div>
                    </td>
                </tr>
                @endforelse
