...
<div class="profile-header animate-fadeInUp">
    <div class="relative z-10">
        <div class="flex flex-col md:flex-row items-start md:items-center gap-6">
            ...
            <!-- Report Button -->
            <a href="{{ route('admin.students.report.show', $student) }}"
               class="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-white/20 backdrop-blur-sm text-white font-medium hover:bg-white/30 transition-all hover:scale-105">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div class="info-item">
                                ...
                                <div class="content">
                                    ...
                                    <div class="value">{{ $student->nationality ?? 'غير محدد' }}</div>
                                </div>
                            </div>
                            <div class="info-item">
                    ...
                    <div>
                        ...
                        <div style="display:flex;flex-wrap:wrap;gap:.5rem;">
                            @foreach([
                                ...
                                ['label' => 'تحديث البرنامج',   'title' => 'تحديث مهم بشأن برنامجك',        'body' => 'نود إعلامك بوجود تحديثات مهمة تخص برنامجك التدريبي .'],
